...
typedef void (*imu_data_cb_ctx_t)(const imu_raw_data_t *data, size_t count,
                                  void *user_ctx);
 ...
 */
DSP_Config_t IMU_Calculate_DSP_Config(SensorDriver_t *sensor, float target_rpm,
                                      float C, float H, float F_env,
                                      float delta_f_max);
 ...
 */
DSP_Config_t IMU_Get_Fixed_DSP_Config(SensorDriver_t *sensor, float target_odr,
                                      uint32_t fft_points,
